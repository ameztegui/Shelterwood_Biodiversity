...
# Abundance
modelcomp_ab <- read.delim ("./Results/ModelComparison_Abu2.txt", dec=".", header=T)
parameters_ab <- read.delim ("./Results/ModelParameters_Abu2.txt", dec=".", header=T)
...
ag_ab2<- data.frame(Variable = c("TOTA","SPEA","GENA", "UBIA",
                                 ...
                                 "OVFA","TRFA", "GRFA", "UNFA",
                                 "NOCA","EXCA", "SECA"),
                    Model = c("nomg.model","nocv.model", "full.model", "nomg.model",
                              "nocv.model", "nomg.model", "nosh.model", "nomg.model",
                              "nomg.model", "nosh.model", "nosh.model", "nomg.model",
                              "full.model","nosh.model", "full.model"))
...
write.table(x=df.min_ab, file="./Results/BestModel_Abu2.txt",sep="\t",dec=".", row.names = F)
